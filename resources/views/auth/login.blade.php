                ...
                <div class="floating-label">
                    ...
                    <div class="icon profile-icon">
                        <svg class="svg" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path class="st1" 
                                d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-4.41 0-8 3.59-8 8v2h16v-2c0-4.41-3.59-8-8-8z"/>
                        </svg>
                    </div>
                </div>
                <div class="floating-label">
                    ...
                    <div class="icon">
                        <svg class="svg" enable-background="new 0 0 24 24" version="1.1" viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path class="st1" d="M12 16.5c-0.8 0-1.5-0.7-1.5-1.5s0.7-1.5 1.5-1.5 1.5 0.7 1.5 1.5-0.7 1.5-1.5 1.5z"/>
                        </svg>
                    </div>
                </div>
            </div>
                ...
                <div class="floating-label">
                    ...
                    <div class="icon profile-icon">
                        <svg class="svg" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect class="st0" width="24" height="24"/>
                            <path class="st1" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-4.41 0-8 3.59-8 8v2h16v-2c0-4.41-3.59-8-8-8z"/>
                        </svg>
                    </div>
                </div>
                <div class="floating-label">
